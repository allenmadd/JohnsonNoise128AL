...
area2<-area[2:7]/100 #take away the short's data
...
Temperature3<-c(71.82, 73.19, 74.53, 74.65, 75.43, 78.52)
...
library(ggplot2)
qplot((Temperature3),(y2))+geom_errorbar(aes(x=(Temperature3), ymin=(y2-Temperature3), ymax=(y2+Temperature3)), width=0.25)+
  geom_smooth(method="lm", se=FALSE, fullrange=TRUE, level=0.95)+labs(title = "Resistance as a function of Gain and Voltage with a 1D Fit", x= "Temperature", y = "V^2/ (4*G)")
#CHANGE THE TITLE
