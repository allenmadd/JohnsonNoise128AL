---
title: "Experiment 2: Temperatures for Gain 250"
...
gain <- data.frame(Frequency = vout1$x, Gain = (m_vout[2]/m_in))/2
...
```{r}
experiment2data<-read.csv("/Users/mallen/Documents/128AL/JohnsonNoise128AL/experiment2data2.csv")
```
...
Temperature2<-unlist(Temperature, use.names = FALSE)/10
Temperature2[2]<-Temperature2[2]/10 #error in data inputting caused 2nd term to be 10* every other term. 
...
```
We see that the reported estimate for the temperatures of the resistors is 285.445, or 285 to our best estimates. If the room temperature was 20.5 as recorded, then the value for absolute 0 in Kelvin is -264.5 pm 9.5 .We expected to find -273.15. t score .91. 