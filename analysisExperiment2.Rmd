...
Then, to find the value of absolute 0 in Celsius, we use the recorded room temperature (20.5 C) and the average Temperature (280.6897K). Solving for absolute 0, you get -260 C. We expected to find -273.15.
```{r}
