...
qplot(unlist(gain[1]),unlist(gain[2]), xlab = "Frequency (Hz)", ylab = "Gain", xlim=c(1,15000))+geom_errorbar(aes(x=unlist(gain[1]), ymin=unlist(gain[2]-gainerror[1]), ymax=unlist(gain[2]+gainerror[1])), width=0.25)
